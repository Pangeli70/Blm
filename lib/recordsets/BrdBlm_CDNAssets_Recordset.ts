...
type BrdBlm_TCDNAsset_Recordset = Record<
    string,
    A3D.ApgA3D_ICDNAsset
>;


export const BrdBlm_CDNAssets_Recordset: BrdBlm_TCDNAsset_Recordset = {



    //--------------------------------------------------------------------------
    // #region Context Environment


    context_outdoor_environment_Grass_Map:
    {
        CDNAssetId: 'context_outdoor_environment_Grass_Map',
        type: A3D.ApgA3D_eTextureType.ALBEDO,
    ...
    context_outdoor_environment_Grass_BumpMap:
    {
        ...
        type: A3D.ApgA3D_eTextureType.BUMP,
    ...
    //--------------------------------------------------------------------------
    // #region Context Outdoor Pavement
    ...
    //--------------------------------------------------------------------------
    // #region Context Outdoor Threshold

    // #endregion
    //--------------------------------------------------------------------------

    //--------------------------------------------------------------------------
    // #region Context Outdoor Frame

    // #endregion
    //--------------------------------------------------------------------------

    //--------------------------------------------------------------------------
    // #region Context Outdoor Sidewalk

    // #endregion
    //--------------------------------------------------------------------------

    //--------------------------------------------------------------------------
    // #region Context Outdoor Baseboard

    // #endregion
    //--------------------------------------------------------------------------

    //--------------------------------------------------------------------------
    // #region Context Indoor Walls
    ...
    //--------------------------------------------------------------------------
    // #region Context Indoor Floor

    // #endregion
    //--------------------------------------------------------------------------

    //--------------------------------------------------------------------------
    // #region Context Indoor Baseboard

    // #endregion
    //--------------------------------------------------------------------------

    //--------------------------------------------------------------------------
    // #region Context Indoor Ceiling
